...
yarn snarkjs groth16 setup "build/$1.r1cs" pot/pot13_final.ptau "pot/$1_0000.zkey"
...
yarn snarkjs zkey verify "build/$1.r1cs" pot/pot13_final.ptau "pot/$1_final.zkey"
